...
- **Muted Hover-to-Preview**: Gallery cards play video snippets on hover with anti-flicker delay.
- **Filterable Archive & Live Search**: Instant filtering by category and live search across editing techniques.
- **Fullscreen Project Modal**: Detailed breakdown of editing focus (Color Grading, Sound Design, Kinetic Typography, Pacing).
- **Direct Client Channels**: Instant links for WhatsApp, Phone (`9345313552`), Email (`thiru15102005@gmail.com`), Instagram (`@actorthiru_`), and an interactive brief generator.
...
- **Styling**: Tailwind CSS + Custom Cinematic Glassmorphism Utilities
...
### 3. Add Video Assets
Place video files inside the `VIDEOS/` folder structured as:
```
VIDEOS/
├── DIGITAL MARKETING/
├── EVENT MANAGEMENT/
